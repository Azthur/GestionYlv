    ...
    dtConciliados = $('#tableConciliados').DataTable({
        ...
        columns: [
            ...
            { 
                ...
                searchable: false,
                render: function(data, type, row) {
                    return `<button class="btn btn-outline" style="color:var(--danger); border-color:var(--danger); padding:0.25rem 0.5rem; font-size:0.75rem;" onclick="unmatchBankSwal('${row.Id}')" title="Deshacer Match">
